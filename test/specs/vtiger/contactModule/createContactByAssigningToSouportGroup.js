describe("CreateContact",async()=>{
    it("CreateContactWithOrganization",async()=>{
        ...
        var radioButton=await browser.$('//input[@value="T"]')
        await radioButton.click()
        var groupDropdown= await browser.$('//select[@name="assigned_group_id"]')
        await groupDropdown.selectByVisibleText("Support Group")
